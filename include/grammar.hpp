...
enum struct NonTerminal { E_BASE = 0, E, T, F };

std::string nonterminal_to_string(NonTerminal t) {
    switch (t) {
    case NonTerminal::E_BASE:
        return "E'";
    case NonTerminal::E:
        return "E";
    case NonTerminal::T:
...
std::string grammar_to_string(GrammarRuleType t) {
    switch (t) {
    case GrammarRuleType::E_BASE:
        return "E' -> E";
    case GrammarRuleType::E_ADD:
        return "E -> E + T";
    case GrammarRuleType::E_SUB:
        return "E -> E - T";
    case GrammarRuleType::E_T:
        return "E -> T";
    case GrammarRuleType::T_MUL:
        return "T -> T * F";
    case GrammarRuleType::T_DIV:
        return "T -> T / F";
    case GrammarRuleType::T_F:
        return "T -> F";
    case GrammarRuleType::F_EXPR:
        return "F -> (E)";
    case GrammarRuleType::F_ID:
        return "F -> id";
    default:
        return "UNKNOWN";
    }
